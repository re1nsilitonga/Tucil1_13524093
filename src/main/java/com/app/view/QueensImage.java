...
public class QueensImage {
    ...
    @FXML public ImageView inputImageView;
    @FXML public TextArea solutionTextDisplay;
    @FXML public ImageView outputImageView;
    @FXML public Label statsLabel;
    @FXML public ProgressBar progressBar;
    @FXML public VBox root;
    
    public QueensImage(Stage primaryStage) {
    ...
    public void initUI() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("QueensImage.fxml"));
    ...
    public TextArea getSolutionTextDisplay() {
        return solutionTextDisplay;
    }
